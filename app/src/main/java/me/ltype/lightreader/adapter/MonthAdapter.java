...
public class MonthAdapter extends RecyclerView.Adapter<MonthAdapter.ViewHolder> {
    ...
    public MonthAdapter(Activity activity, String month) {
        ...
        /*Cursor cursor = mResolver.query(LightReaderDataStore.Bookmarks.CONTENT_URI, new String[]{LightReaderDataStore.Bookmarks.POSITION},
                LightReaderDataStore.Bookmarks.CHAPTER_ID + " = " + chapterIdList.get(chapterIndex), null, null);
